...
<div class="col-md-12">
    <div class="block">
        ...
        <div class="content controls">
            <form action="<?= site_url('News/new_news_execute') ?>" method="post" enctype="multipart/form-data">
                <div class="form-row">   
                ...
                <div class="form-row">   
                    ...
                    <div class="col-md-9">                      
                        <input name="date" type="date" class="form-control datepicker" required="">
                    </div>                  
                </div>
                <div class="form-row">   
                ...
                <div class="form-row">   
                    ...
                    <div class="col-md-9">                      
                        <textarea name="content" cols="10" class="form-control" required="" ></textarea>
                    </div>                  
                </div>
                <div class="form-row">   
