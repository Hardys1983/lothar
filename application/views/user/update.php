<?php 
	function is_selected($company, $user){
		if($company->cell_phone_company_id == $user->cell_phone_company_id){
...
<div class="col-md-8">
    <div class="block">
        <div class="header">
            <h2><?=translate('update_user_data')?></h2>
        </div>
        ...
        <div class="content controls">
        	<form action="<?=site_url('user/update_execute')?>" method="post" enctype="multipart/form-data">
        		<div class="form-row">
	                <div class="col-md-3"><?=translate('full_name')?>:</div>
	                <div class="col-md-9">
	                <input type="text" class="form-control" value="<?=$user->name?>" name="name" required="required"></div>
	            </div>
	            
	            <div class="form-row">
	                <div class="col-md-3"><?=translate('ci')?>:</div>
	                <div class="col-md-9">
	                <input type="text" class="form-control" value="<?=$user->ci?>" name="ci" required="required"></div>
	            </div>
	            ...
	            <div class="form-row">
	                ...
	                <div class="col-md-9">
	                <input type="text" class="form-control" value="<?=$user->address?>" name="address" required="required"></div>
	            </div>
	            ...
	            <div class="form-row">
	                ...
	                <div class="col-md-9">
	                <input type="email" class="form-control" value="<?=$user->email?>" name="email" required="required"></div>
	            </div>
	            
	            <div class="form-row">
	                <div class="col-md-3"><?=translate('phone')?>:</div>
	                <div class="col-md-9">
	                <input type="phone" class="form-control" value="<?=$user->phone?>" name="phone" required="required"></div>
	            </div>
	                ...
	                <div class="col-md-9">
	                    <select class="form-control" name="cell_phone_company">
	                        ...
	                        <?php foreach($cell_companies as $company): ?>
	                        	<option <?php is_selected($company, $user)?> value="<?=$company->cell_phone_company_id?>"><?=$company->company_name?></option>
	                     	<?php endforeach; ?>
	                    </select>
	                </div>
	            </div> 
	            ...
	            <div class="form-row">
	                ...
	                <div class="col-md-9">
	                <input type="phone" class="form-control" value="<?=$user->cell_phone?>" name="cell_phone" required="required"></div>
	            </div>
