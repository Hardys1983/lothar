<div class="row">
    <div class="col-md-12">
        <ol class="breadcrumb">                    
            ...
            <li><a href="<?= site_url('Mechanic/index') ?>"><?= translate('work_orders') ?></a></li>
            <li><a href='<?= site_url("Mechanic/activities/$work_order->work_order_id") ?>'><?= translate('activities') ?></a></li>                    
...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="block">
            ...
            <div class="content controls">
                <form action="<?= site_url('Mechanic/update_observation_execute') ?>" method="post">
                    <div class="form-row">   
