                    ...
                    <nav class="navbar brb" role="navigation">
                        ...
                        <div class="collapse navbar-collapse navbar-ex1-collapse">                                     
                            <ul class="nav navbar-nav">
                                <li><a href="<?= site_url('Mechanic/activities') ?>"><span class="fa fa-list"></span> Actividades</a></li>         
                                <li><a href="<?= site_url('Mechanic/observation') ?>"><span class="fa fa-eye"></span> Observaciones</a></li>   
