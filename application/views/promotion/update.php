...
<div class="col-md-12">
    <div class="block">
        ...
        <div class="content controls">
            <div class="block">
                <div class="col-md-12">
                    <img class="image_promotion_update" src="<?php echo base_url() . $promotion->picture ?>">
                </div>
            </div>   
        </div>

        <div class="content controls">
            <form action="<?= site_url('Promotion/update_promotion_execute') ?>" method="post" enctype="multipart/form-data">
                <input type="hidden" name="promotion_id" value="<?= $promotion->promotion_id?>">
                <div class="form-row">   
                    <div class="col-md-3"><?= translate('begin') ?>:</div>
                    <div class="col-md-9">                      
                        <input name="begin" type="date" class="form-control datepicker" required="" value="<?= $promotion->begin ?>">
                    </div>                  
                </div>
                <div class="form-row">   
                    <div class="col-md-3"><?= translate('end') ?>:</div>
                    <div class="col-md-9">                      
                        <input name="end" type="date" class="form-control datepicker" required="" value="<?= $promotion->end ?>">
                    </div>                  
                </div>
                <div class="form-row">   
                ...
                <div class="form-row">   
                    ...
                    <div class="col-md-9">                      
                        <textarea name="description" cols="10" class="form-control" required="" ><?= $promotion->description ?></textarea>
                    </div>                  
                </div>
                <div class="footer">
