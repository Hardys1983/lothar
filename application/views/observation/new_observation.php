<div class="row">
    <div class="col-md-12">
        <ol class="breadcrumb">                    
            <li><a href='<?= site_url("Vehicular_reception/observations") ?>'><?= translate('observation') ?></a></li>                    
...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="block">
            ...
            <div class="content controls">
                <form action="<?= site_url('Vehicular_reception/new_observation_execute') ?>" method="post">
                    <div class="form-row">   
